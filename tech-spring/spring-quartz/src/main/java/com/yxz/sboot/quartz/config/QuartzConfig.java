package com.yxz.sboot.quartz.config;


import com.yxz.sboot.quartz.extend.AutowiringSpringBeanJobFactory;
...
public class QuartzConfig {
    ...
    public Properties quartzProperties() {
         ...
         */
        quartzProps.setProperty("org.quartz.dataSource.myDS.connectionProvider.class", "com.yxz.sboot.quartz.config.DruidConnectionProvider");
