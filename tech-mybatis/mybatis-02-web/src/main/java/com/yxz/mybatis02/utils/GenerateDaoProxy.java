package com.yxz.mybatis02.utils;
...
public class GenerateDaoProxy {
    ...
    public static Object generate(SqlSession sqlSession, Class daoInterface) {
        ...
        // 制造类(com.yxz.mybatis.dao.AccountDao --> com.yxz.mybatis.dao.AccountDaoProxy)
        ...
        Arrays.stream(methods).forEach(method -> {
            ...
            try {
                ...
                methodCode.append("{");
                // 需要方法体当中的代码
                methodCode.append("org.apache.ibatis.session.SqlSession sqlSession = com.yxz.mybatis.utils.SqlSessionUtil.openSession();");
                // 需要知道是什么类型的sql语句
